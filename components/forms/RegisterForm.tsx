...
import { createUser, registerPatient } from "@/lib/cmd/patient.actions";
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <section className="space-y-6">
          <div className="mb-9 space-y-1">
            <h2 className=" text-xl md:text-2xl">Medical Information</h2>
          </div>
        </section>
        ...
        <section className="space-y-6">
          <div className="mb-9 space-y-1">
            <h2 className=" text-xl md:text-2xl">Consent and Privacy</h2>
          </div>
        </section>
